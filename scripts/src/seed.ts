...
The brief still generates with live data, but without the AI narrative layer. Add OPENAI_API_KEY in your environment to unlock full AI briefings.`,
  ...
  await db.insert(automationsTable).values([
    ...
    },
    {
      ...
      runsTotal: 3,
      runsSuccess: 3,
      lastRunAt: new Date("2026-07-14T07:00:00Z"),
    },
    {
      ...
      runsTotal: 3,
      runsSuccess: 3,
      lastRunAt: new Date("2026-07-14T07:05:00Z"),
    },
    {
      ...
      runsTotal: 3,
      runsSuccess: 3,
      lastRunAt: new Date("2026-07-14T07:10:00Z"),
    },
    {
      ...
      runsTotal: 3,
      runsSuccess: 3,
      lastRunAt: new Date("2026-07-14T07:15:00Z"),
    },
    {
      ...
      runsTotal: 3,
      runsSuccess: 3,
      lastRunAt: new Date("2026-07-14T07:20:00Z"),
    },
    {
      ...
      runsTotal: 3,
      runsSuccess: 3,
      lastRunAt: new Date("2026-07-14T07:25:00Z"),
    },
    {
      ...
      runsTotal: 3,
      runsSuccess: 3,
      lastRunAt: new Date("2026-07-14T07:30:00Z"),
    },
    {
    ...
    },
    {
      ...
      runsTotal: 3,
      runsSuccess: 3,
      lastRunAt: new Date("2026-07-14T07:35:00Z"),
    },
    {
    ...
    },
    {
      ...
      runsTotal: 3,
      runsSuccess: 3,
      lastRunAt: new Date("2026-07-14T07:40:00Z"),
    },
  ]);
