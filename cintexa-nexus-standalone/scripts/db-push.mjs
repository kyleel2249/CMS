...
// Apply every migration file in migrations/, in filename order (drizzle-kit's
// generated names sort chronologically, e.g. 0000_x.sql, 0001_y.sql, ...).
// This directory is regenerated by `pnpm --filter @workspace/scripts run
// build-standalone` from lib/db/drizzle — do not hand-edit its contents.
...
if (migrationFiles.length === 0) {
  console.log("⚠️  No migration files found in scripts/migrations/.");
}
